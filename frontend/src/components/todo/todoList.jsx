...
export function TodoList() {
  ...
  return (
    ...
    <div className="bg-gray-100 ring-1 rounded ring-gray-200 flex flex-col">
      ...
      {todos.length > 0 && (
        <table className="table-fixed table-auto border-collapse border border-gray-300 w-full">
            <thead>
                <tr>
                    <th className="border border-gray-300 px-2 py-1 w-64">Title</th>
                    <th className="border border-gray-300 px-2 py-1">Description</th>
                    <th className="border border-gray-300 px-2 py-1 w-40">Date</th>
                    <th className="border border-gray-300 px-2 py-1 w-50" colSpan={2}>Actions</th>
                </tr>
            </thead>
            <tbody>
                {todos.map((todo) => (
